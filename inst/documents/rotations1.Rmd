...
dfr <- run_rot(rotation_interval=50, max_gen = 300, hardcode_fitness = TRUE, same_insecticides =TRUE, migration=0.01)
...
dfr <- run_rot(rotation_interval=50, max_gen = 300, hardcode_fitness = TRUE, same_insecticides =TRUE, migration=0.001)
...
dfr <- run_rot(rotation_interval=0, max_gen = 300, hardcode_fitness = TRUE, same_insecticides =TRUE, expo_hi=0.5, migration=0.01)
...
run_rot( n_insecticides = 3 , max_gen = 150 , start_freqs = 0.1 , rotation_interval = 50 , eff = 0.6 , dom = 0.5 , rr = 0.5 , expo_hi = 0.5 , coverage = 0.8 , migration = 0.01 , cost = 0.1 )
...
run_rot( n_insecticides = 3 , max_gen = 150 , start_freqs = 0.1 , rotation_interval = 50 , eff = 0.6 , dom = 0.5 , rr = 0.5 , expo_hi = 0.5 , coverage = 0.8 , migration = 0.01 , cost = 0 )
