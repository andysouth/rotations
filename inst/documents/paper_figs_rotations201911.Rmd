...
dfseq <- run_rot(rot_interval=0, n_insecticides=4, start_freqs=0.0026, cost=c(0), eff=c(0.98), dom_sel=c(0.96), dom_cos=c(0.32), rr=c(0.12), expo_hi=0.75, male_expo_prop=0.34, coverage=1, migration=0,
min_rwr_interval=10, plot=FALSE, max_gen=500, mort_or_freq = 'freq')

dfrot <- run_rot(rot_interval=10, n_insecticides=4, start_freqs=0.0026, cost=c(0), eff=c(0.98), dom_sel=c(0.96), dom_cos=c(0.32), rr=c(0.12), expo_hi=0.75, male_expo_prop=0.34, coverage=1, migration=0,
min_rwr_interval=10, plot=FALSE, max_gen=500, mort_or_freq = 'freq')

ggseq <- rot_plot_resistance(dfseq, plot=FALSE, plot_mort=FALSE )
ggrot <- rot_plot_resistance(dfrot, plot=FALSE, plot_mort=FALSE )

ggseq <- ggseq + theme(legend.position="none")
ggrot <- ggrot + theme(legend.position="bottom",
...
dfseq <- run_rot(rot_interval=0, n_insecticides=4, start_freqs=0.0026, cost=c(0.02), eff=c(0.98), dom_sel=c(0.96), dom_cos=c(0.32), rr=c(0.12), expo_hi=0.75, male_expo_prop=0.34, coverage=1, migration=0,
min_rwr_interval=10, plot=FALSE, max_gen=500, mort_or_freq = 'freq')

dfrot <- run_rot(rot_interval=10, n_insecticides=4, start_freqs=0.0026, cost=c(0.02), eff=c(0.98), dom_sel=c(0.96), dom_cos=c(0.32), rr=c(0.12), expo_hi=0.75, male_expo_prop=0.34, coverage=1, migration=0,
min_rwr_interval=10, plot=FALSE, max_gen=500, mort_or_freq = 'freq')
...
dfseq <- run_rot(rot_interval=0, n_insecticides=4, start_freqs=0.0026, cost=c(0), eff=c(0.98), dom_sel=c(0.96), dom_cos=c(0.32), rr=c(0.12), expo_hi=0.75, male_expo_prop=0.34, coverage=0.3, migration=0.1, min_rwr_interval=10, plot=FALSE, max_gen=500, mort_or_freq = 'freq')

dfrot <- run_rot(rot_interval=10, n_insecticides=4, start_freqs=0.0026, cost=c(0), eff=c(0.98), dom_sel=c(0.96), dom_cos=c(0.32), rr=c(0.12), expo_hi=0.75, male_expo_prop=0.34, coverage=0.3, migration=0.1, min_rwr_interval=10, plot=FALSE, max_gen=500, mort_or_freq = 'freq')
...
# B1 frequency switch insecticides different, no costs no disp
...
```{r figx-PRCC, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
