...
```{r, eval=TRUE, fig.height=2.5, fig.width=7, fig.show='hold', fig.align='left', fig.cap="A sequence with 1 percent dispersal between treated and untreated areas of equal size (no resistance costs)."}

dfr <- run_rot(n_insecticides=2, max_gen = 200, rot_interval=0, expo_hi=0.5, eff=0.8, cost=0, coverage=0.5, migration = 0.01)

```

```{r, eval=TRUE, fig.height=2.5, fig.width=7, fig.show='hold', fig.align='left', fig.cap="A 1 year rotation with 1 percent dispersal between treated and untreated areas of equal size (no resistance costs)."}

dfr <- run_rot(n_insecticides=2, max_gen = 200, rot_interval=10, expo_hi=0.5, eff=0.8, cost=0, coverage=0.5, migration = 0.01)
...
```{r, eval=TRUE, fig.height=2.5, fig.width=7, fig.show='hold', fig.align='left', fig.cap="A sequence with dispersal between treated and untreated areas and resistance cost of 0.005."}

#upped max_gen because migration and cost decrease rise in resistance
dfr <- run_rot(n_insecticides=2, max_gen = 200, rot_interval=0, expo_hi=0.5, eff=0.8, cost=0.005, coverage=0.5, migration = 0.01)

```

```{r, eval=TRUE, fig.height=2.5, fig.width=7, fig.show='hold', fig.align='left', fig.cap="A 1 year rotation with with dispersal between treated and untreated areas and resistance cost of 0.005."}

dfr <- run_rot(n_insecticides=2, max_gen = 200, rot_interval=10, expo_hi=0.5, eff=0.8, cost=0.005, coverage=0.5, migration = 0.01)
...
dfr <- run_rot(n_insecticides=2, max_gen = 200, rot_interval=0, expo_hi=0.5, eff=0.8, cost=0.005, coverage=1, migration = 0, dom_cos = 0, rot_criterion = 0.9, start_freqs = 0.001)

```

```{r, eval=TRUE, fig.height=2.5, fig.width=7, fig.show='hold', fig.align='left', fig.cap="dominance of cost 0."}

dfr <- run_rot(n_insecticides=2, max_gen = 200, rot_interval=10, expo_hi=0.5, eff=0.8, cost=0.005, coverage=1, migration = 0, dom_cos = 0, rot_criterion = 0.9, start_freqs = 0.001)

```

```{r, eval=TRUE, fig.height=2.5, fig.width=7, fig.show='hold', fig.align='left', fig.cap="dominance of cost 1."}

dfr <- run_rot(n_insecticides=2, max_gen = 200, rot_interval=0, expo_hi=0.5, eff=0.8, cost=0.005, coverage=1, migration = 0, dom_cos = 1, rot_criterion = 0.9, start_freqs = 0.001)

```

```{r, eval=TRUE, fig.height=2.5, fig.width=7, fig.show='hold', fig.align='left', fig.cap="dominance of cost 1."}

dfr <- run_rot(n_insecticides=2, max_gen = 200, rot_interval=10, expo_hi=0.5, eff=0.8, cost=0.005, coverage=1, migration = 0, dom_cos = 1, rot_criterion = 0.9, start_freqs = 0.001)
