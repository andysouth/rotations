...
*todo change this bit, we could actually use time-to-resistance for all strategies ?*
*make it clearer exactly what we do*
...
## TODO
*add to methods description of how fitness determined in model, move & modify fig 1*
