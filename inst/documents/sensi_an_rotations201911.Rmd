...
# no colour ??
# ggplot(df_res_all, aes(x=rot_minus_seq, colour=rot_minus_seq)) + 
#      geom_histogram(binwidth=10) + 
...
ggplot(df_res_16, aes(x=rot_minus_seq, fill=best_strategy)) + 
     ...
     theme(panel.grid.minor.y=element_blank()) +
     facet_grid(rows=vars(id14), cols=vars(idAD), labeller=labeller(idAD=idAD_lookup, id14=id14_lookup))
...
# quick, not very successful look at modelling it
# library(mgcv)
