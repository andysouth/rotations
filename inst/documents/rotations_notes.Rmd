...
~ try a solution to the diff insecticide problem. If no other insecticides are below resistance thresh and this one is then can keep using it in a rotation ...
...
done 2. check ability to do runs where insecticides differ
