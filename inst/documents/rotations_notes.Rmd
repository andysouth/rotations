...
what to call new UI resistrot consistent with resistmixseq


# TODO

Explore idea from Rowland (1981) that resistance declines faster when it is mostly held by the RR (i.e. at higher allele frequencies) 
