...
Decide whether to use min_rwr_interval OR min_gens_switch_back 


Before sending to Ian.

~ add to methods about min rwr interval
~ add about keeping resistance allele freq at starting level
~ add to fig Y legend Ians caveats
