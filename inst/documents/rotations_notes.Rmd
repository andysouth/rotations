...
# in rotation_runs2019.Rmd uncomment the line below and re-add calc gens-under-thresh
# gens <- gens_under_thresh(dfres=dfres, threshold=threshold, mort_or_freq=linputs$mort_or_freq)

*check on new outputs : tot-gens, mean-mort
