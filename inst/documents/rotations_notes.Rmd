...
# I think we allow sequence to exit at anytime ? This gives a kind of advantage to sequences, rotations tend to end up with more generations above threshold.
# so now we want to only allow sequences to exit at annual time points (if an option is enabled)
