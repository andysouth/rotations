...
I would like to modify setInputOneScenario.r so I'm not referencing inputs by there location in the matrix which seems dangerous, but I might not be able to get around ?
...
start thinking about how best to run sensitivty analysis & collect or post-process to get num gens under 50% threshold.
