...
implemented set_expsoure_rot() but currently changing exposure seems to make no difference ?
dfr <- run_rot(rotation_interval=50, expo_hi=0.9)
dfr <- run_rot(rotation_interval=50, expo_hi=0.2)
# these produce identical frequency curves for r1 & r2
...
# TODO
~ implement set_exposure_rot() to replace test version 
