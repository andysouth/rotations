...
1. find & fix problem with C runs see above
2. add change_interval as an input
3. should I set min_gens_switch_back and min_rwr_interval to 0, they should have no effect
