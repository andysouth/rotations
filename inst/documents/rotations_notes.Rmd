...
For rotations send Jim a scaled down version of the rotations sensitivity analysis code. That just runs the sensitivity analysis and Jim will have a go at parallelising it.

Still occasionally getting error from shinyUI resistrot :
Warning: Error in raf_get: object 'RAF' not found
