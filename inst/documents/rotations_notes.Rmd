...
CHECK THE DIFFERENCE between linputs in run_rot() which is working compared to the input csv which mostly doesn't work.


~ something is wrong both when mort_or_freq set to mort and freq

~ when set to freq the first insecticide doesn't stop being used
  when set to mort the first insecticide is just used very briefly




~ add log-normal distribution for frequency
~ how to deal with running seq vs rotations
