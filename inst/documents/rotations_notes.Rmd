...
I'm nervous about making the rotation repsonsive. We both said that i unlikely to happen in the field.
...
~ fix migration rate to be between 0 & 1, where 1 is random movement.
~ read Ians document

~ set dominance of cost and dominance of selection to be different in fitness_single_locus().

~ Ian & I talked about using fitness to detremine changes. and that fitness could be used as an index of population, but Ian was sceptical, he said to look up fitness determinants of population on wikipedia, about soft & hard selection.
