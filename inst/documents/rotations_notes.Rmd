...
e.g. :
run_rot( n_insecticides = 3 , max_generations = 150 , start_freqs = 0.01 , rotation_interval = 50 , eff = 0.7 , dom = 0.5 , rr = 0.5 , expo_hi = 0.7 , coverage = 0.8 , migration_rate_intervention = 0.01 , cost = 0.1 )
