...
~ resize no square figs, make sure one per page
...
*today*
done ~ reread Ians text about dominance
~ move rotations repo back to my github
~ update R
done ~ tweet to malaria journal
~ think more about rotations datavis
done ~ read the alphey oxitech modelling papers

To talk with Ian about next week :
~ min_rwr_interval vs min_gens_switch_back

Look at Hackett R code. Could it be an even simpler model that we could use ?
The R code is here and looks quite accessible :
https://datadryad.org//resource/doi:10.5061/dryad.4s405
