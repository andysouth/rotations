...
~ check that I fixed issue below :
see why insecticide_check() is failing for mort

~ work out what we want Sam to do
~~ do 16 sets of 10,000 runs
~~ what analyses on outputs
