...
~ I can redesign the insecticide switch function slightly :

to pass :
current_insecticide
n_insecticides
RAF1gen
df_results : to allow assessment of which insecticides have been used previously

return :
current_insecticide : if it has failed to find one then return 0

BUT i need to allow ability to assess when insecticides have been used previously so may need to pass df_results too
